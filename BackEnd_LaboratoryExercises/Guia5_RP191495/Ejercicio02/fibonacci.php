...
<body>
    ...
    <div class="container">
        ...
        if (isset($_GET['enviar'])):
            ...
            $tabla .= "<th scope='col'>Valor</th></tr>";
            $tabla .= "</thead>";
            $tabla .= "<tbody>";
            $i = 0;
            /**
             * Con este contador se verifica que se genere el numero de terminos
             * en la serie que indico el usuario en el formulario.
             */
            while ($i <= $numero1) {
            ...
            <form action="<?PHP echo $_SERVER['PHP_SELF']; ?>" method="GET">
                <div class="form-group row">
                    ...
                    <input class="form-control" value="0" type="text" name="txtnumero" id="txtnumero"
                     size="4" maxlength="3" pattern="[0-9]{1,3}" required />
                </div>
