...
if(isset($_POST['submit']) && $_POST['submit']=="Enviar"):
    ...
    extract($_POST);
    $cliente = !empty($client) ? $client: "<a href=\"ingresadatos.html\">No ingreso el cliente.</a>";
    echo "\t\t<td>\n". $cliente . "\n</td>\n";
    echo "\t</tr>\n";
    echo "\t<tr>\n";
    echo "\t\t<td>\nProducto\n</td>\n";
    $producto = !empty($product) ? $product: "<a href=\"ingresadatos.html\">No ingreso el producto.</a>";
    echo "\t\t<td>\n". $producto . "\n</td>\n";
    echo "\t</tr>\n";
    echo "\t<tr class=\"odd\">\n";
    echo "\t\t<td>\nPrecio\n</td>\n";
    $precio = !empty($price) ? $price: "<a href=\"ingresadatos.html\">No ingreso el precio.</a>";
    echo "\t\t<td>\n". $precio . "\n</td>\n";
    echo "\t</tr>\n";
    echo "\t<tr>\n";
    echo "\t\t<td>\nCantidad\n</td>\n";
    $cantidad = !empty($quantity) ? $quantity : "<a href=\"ingresadatos.html\">No ingreso el precio.</a>";
    echo "\t\t<td>\n". $cantidad . "\n</td>\n";
    echo "\t</tr>\n";
        echo "\t<tr class=\"odd\">\n";
        echo "\t\t<td>\nTotal a pagar\n</td>\n";
...
<div id="link">
    <a href="ingresadatos.html" class="button-link">Ingresar nuevos datos</a>
</div>
</div>
</article>
</section>
