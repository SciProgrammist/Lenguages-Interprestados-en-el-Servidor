<?php
    ...
    // Implementacion de un carrito de compras basico usando cadenas de consulta (query string).

    function generarCarrito()
    {
        // Se utilizara una matriz para manejar el carrito
        $carrito = array();

        /**
         *  Los articulos y sus cantidades se enviarán con el
         *  metodo GET, ya sea en la cadena de consulas o a
         *  través de campos ocultos de formularios.
         *
         */

         foreach ($_GET as $ref => $unidades) {

            if (preg_match("/^ref/", $ref)) $carrito[$ref] = $unidades;
    ...
    function mostrarCarrito($carrito)
    {
        ...
        // Generacion de la cabercera de la tabla.
        ...
        // Bandera de estado por ejecucio exitosa
        return true;
    }

    // Método que muestra los articulos disponibles en la tienda.
    function estantes($carrito) {
         ...
         */
         ...
         <div class='col'>
            ...
            <div class='card-footer'><a href='./compra.php?{$querystring}articulo=ref2' title='Añadir al carrito'>
            Comprar </a></div>
            </div>
            </div>
            <div class='col'>
