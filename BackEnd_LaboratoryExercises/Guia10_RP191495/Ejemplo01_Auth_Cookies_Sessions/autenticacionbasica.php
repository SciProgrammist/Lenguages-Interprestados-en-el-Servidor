...
if (
   substr($_SERVER['SERVER_SOFTWARE'], 0, 9) == 'Microsoft' && !isset($_SERVER['PHP_AUTH_USER'])
...
function CheckUserSession() {
 $serverSide = ($_SERVER['PHP_AUTH_USER'] != 'lis') || ($_SERVER['PHP_AUTH_PW'] != 'ingenieria');
 //$no_sessionSide = !((isset($_SESSION['user']) && isset($_SESSION['pass'])));
 return ($serverSide);
}
