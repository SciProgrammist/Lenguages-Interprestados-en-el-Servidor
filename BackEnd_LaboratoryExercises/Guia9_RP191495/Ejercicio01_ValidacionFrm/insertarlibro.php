...
<body class="container">
    ...
    <section>
        <article>
            ...
            $planconsulta .= "VALUES (?, ?, ?, ?)";
            $setencia = $db->prepare($planconsulta);
            /*
            ...
            $setencia->bind_param("sssd", $isbn, $autor, $titulo, $precio);
            $setencia->execute();
            echo "<div class=\"query\">\n\t<p>\n\t\t";
            echo $setencia->affected_rows . " libro(s) agregado(s) a la base de datos \n";
            echo "</p>\n</div>\n";
            $setencia->close();
            /*
            ...
            <section class="m-b-30 m-t-30">
                <div class="row pager">
                    <div class="col-md-6 text-left">
                        <a href="menuopciones.html" class="d-block h3 font-wight-normal">Regresar<br>
