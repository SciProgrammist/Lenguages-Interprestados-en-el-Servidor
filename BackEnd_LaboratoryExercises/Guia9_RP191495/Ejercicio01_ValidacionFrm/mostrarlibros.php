...
<body class="container">
     ...
     */
      ...
      * para modificar libros ejecutar primero la actualizacion
      * del registro.
      */
      ...
      if (isset($_POST['guardar']))
       {
            ...
            */
             ...
             *  enviados del formulario de modificacion de libros.
             *
             */
        ...
        if (isset($_GET['del']) && $_GET['del'] == "s")
        {
            ...
            $resultc  = $db->query($consulta);
            $num_results = $db->affected_rows;
            echo "se ha eliminado" . $num_results . " registros de isbn = " . $_GET['id'] . "<br>";
