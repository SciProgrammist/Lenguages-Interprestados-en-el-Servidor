     ...
     */
     ...
     function print_Payment_Info()
     {
        ...
        for ($count = 0; $count < $terms; $count++)
        {
            ...
            $tablePayments .= "<td>"
             .  $this->theLoanYear  .  "/". $this->calc_month() ."/"  . $this->theDay.   "</td>";
     ...
     function calc_month()
     {
        switch ($this->monthIndex) {
            case 1:
                ...
                break;
            case 2:
                //Porque febrero tiene menos dias que otros meses
                $dia = (int)$this->theDay;
                if (((int)$this->theLoanYear%4 == 0) && ((int)$this->theLoanYear%100 != 0)) {
                    $this->theDay = (int)$this->theDay-2;
                }elseif ($dia == 31) {
                    $this->theDay = (int)$this->theDay-3;
                } elseif ($dia == 30) {
                    $this->theDay = (int)$this->theDay-2;
                }
                $month_name="February";
